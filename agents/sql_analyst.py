...
if __name__ == "__main__":
    ...
    print(sql_analyst_response['generated_sql_query'])  # Print the final answer generated by the agent

    print("******************************")

    print(sql_analyst_response['sql_query_expected_result'])  # Print the final answer generated by the agent

    print("******************************")

    print(sql_analyst_response['prompt_query_context'])  # Print the final answer generated by the agent